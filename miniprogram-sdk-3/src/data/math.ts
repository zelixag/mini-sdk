// @ts-nocheck
// 3D Math library for avatar rendering pipeline
// Ported from Web SDK src/utils/Math.ts
...
export function mat_to_quaternion(mat: mat3 | mat4): vec4 {
    ...
    let trace_2sqrt = 2.0 * Math.sqrt(trace);
...
export function Euler_to_mat(angles: vec3, order: string = "xyz"): mat3 {
