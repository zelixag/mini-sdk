...
export { AbortController, AudioAdapter, AudioRenderer, AvatarRendererMP, AvatarStatus, CanvasAdapter, DataCacheQueueMP, Decoder, EFrameDataType, GLDeviceMP, GLPipelineMP, InitModel, LogLevel, MiniProgramWebSocket, ParallelDecoder, RenderSchedulerMP, RenderState, ResourceManagerMP, UIRenderer, XmovAvatarMP, clamp, createCanvasAdapter, createIdentityMatrix, createModuleLogger, createOrthographicMatrix, createPerspectiveMatrix, createWebSocket, XmovAvatarMP as default, degToRad, flatten, get, getWebGLContext, io, lerp, logger, mat4Multiply, mmul, mpRequest, post, radToDeg, request, rotateX, rotateY, rotateZ, scale, smoothstep, translate, transpose };
